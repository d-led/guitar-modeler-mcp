...
func thrII() Device {
	return Device{
		...
		Amps: ampGrid(
			...
			[5]string{"CLEAN BOUTIQUE", "CLEAN", "BOUTIQUE", "A low-watt EL84 design; preamp gain thickens the cleans into bluesy overdrive.", "Fender Blues Junior"},
			...
			[5]string{"CRUNCH CLASSIC", "CRUNCH", "CLASSIC", "EL84 power tubes in a true Class-A configuration with a highly responsive EQ; inspired by British chime.", "Matchless DC30"},
			[5]string{"CRUNCH BOUTIQUE", "CRUNCH", "BOUTIQUE", "A mid-volume boutique design with 6550 power tubes; tight bass and a singing sustain.", "Vox AC30 & Matchless DC30"},
			[5]string{"CRUNCH MODERN", "CRUNCH", "MODERN", "A deceptively simple circuit with a single 12AX7 and EL84; full, no-frills and responsive to picking dynamics.", "Dr. Z Mini Z"},
			...
			[5]string{"LEAD MODERN", "LEAD", "MODERN", "Mid-to-high gain 'Brown sound' voicing with 12AX7 and 6L6 tubes; clean/crunch rock to saturated rhythm and leads.", "EVH 5150-III Channel 2 (Brown Sound)"},
			...
			[5]string{"HI GAIN BOUTIQUE", "HI GAIN", "BOUTIQUE", "ECC83s into 6L6s for high gain with a highly responsive EQ; inspired by German engineering.", "Engl / Diezel"},
			...
			[5]string{"SPECIAL CLASSIC", "SPECIAL", "CLASSIC", "A high-gain design with 12AX7s into EL34s; the hot-rodded British sound that defined 1980s hard rock.", "Marshall JCM800"},
			[5]string{"SPECIAL BOUTIQUE", "SPECIAL", "BOUTIQUE", "Four 12AX7 preamp tubes into 6L6 output tubes; tight, fast tracking for crushing gain.", "Krank Krankenstein"},
			...
			[5]string{"BASS CLASSIC", "BASS", "CLASSIC", "Woody, vintage tone with late breakup.", "Eden Terra Nova / Markbass Little Marcus"},
			...
			[5]string{"BASS MODERN", "BASS", "MODERN", "Vintage voicing with early breakup; works well with bass or guitar.", "Marshall Bass"},
