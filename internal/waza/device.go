...
func Default() Device {
	return Device{
		...
		Amps: device.Items(
			...
			[2]string{"FLAT", "Full-range / neutral preamp, optimised for guitar and acoustic (bass needs extra low-end EQ)"},
		),
		...
		Reverbs: device.Items(
			...
			[2]string{"ROOM REVERB", ""},
			[2]string{"MODULATE REVERB", ""},
		),
